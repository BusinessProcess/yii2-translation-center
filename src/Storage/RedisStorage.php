...
class RedisStorage extends BaseObject implements TranslationStorage
{
    /**
    ...
    public function clearGroup(string $group, array $langs = null): bool
    {
        if (!$langs) {
            ...
            foreach ($langs as $lang) {
                ...
                array_walk($langKeys, function ($key) use (&$keys) { array_push($keys, $key); });
            }
        }
    ...
    protected function buildKey(string $key, string $lang, string $group)
    {
