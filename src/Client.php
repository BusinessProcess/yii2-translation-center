...
class Client extends BaseObject implements Api
{
    ...
    /**
     * @var null|integer number of days that will be used for fetching data. `null` means fetching during all this time.
     */
    public $fetchDays = null;
    ...
    public function fetch(array $params = [], int $page = 1): array
    {
        ...
        $params['pageNum'] = $page;
        if ($this->fetchDays) {
            $params['updatedFrom'] = date(\DateTime::ATOM, (time() - (60 * 60 * 24 * $this->fetchDays)));
        }
